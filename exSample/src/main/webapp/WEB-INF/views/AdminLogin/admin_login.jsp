    ...
    <td><table width="100%" height="420" border="0" cellpadding="0" cellspacing="0" background="img/bg.gif">
        <tr> 
          ...
          <td width="617"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td colspan="4"><img src="/Images/img/admin_img01.gif" width="617" height="60"></td>
              </tr>
              <tr> 
                <td width="9"><img src="/Images/img/admin_img02.gif" width="9" height="314"></td>
                <td width="219"><img src="/Images/img/admin_img03.gif" width="219" height="314"></td>
                <td width="381" align="center" bgcolor="#FFFFFF"><table width="332" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td>&nbsp;</td>
                      <td height="65" valign="top"><img src="/Images/img/admin_img13.gif" width="154" height="26"></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr> 
                      <td>&nbsp;</td>
                    ...
                    <tr> 
                      <td width="12"><img src="/Images/img/admin_img06.gif" width="12" height="107"></td>
                      <td width="308" align="center" background="/Images/img/admin_img07.gif"> 
                        <!-- 도메인, 관리계정, 비밀번호 -->
                        <table width="275" height="63" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td><img src="/Images/img/admin_img09.gif" alt="도메인" width="64" height="19" align="absmiddle"> 
                              <input name="domain" type="text" style="width:140px;" value="websnet.net" readonly></td>
                            <td width="61" rowspan="3"><input type='image' src="/Images/img/admin_img12.gif" alt="connect" value="submit" width="61" height="63" border="0" onfocus=blur()></a></td>
                          </tr>
                          <tr> 
                      ...
                      <td width="12"><img src="/Images/img/admin_img08.gif" width="12" height="107"></td>
                    </tr>
                  </table></td>
                <td width="8"><img src="/Images/img/admin_img04.gif" width="8" height="314"></td>
              </tr>
              <tr> 
                <td colspan="4"><img src="/Images/img/admin_img05.gif" width="617" height="46"></td>
              </tr>
            </table></td>
          <td>&nbsp;</td>
        </tr>
