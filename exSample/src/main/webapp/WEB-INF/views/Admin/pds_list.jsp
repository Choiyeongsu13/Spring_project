...
<c:forEach var = "pds" items = "${pList}">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a class="list" href="/Pds/pds_view?idx=${pds.idx}&page=${page}">${pds.subject}</a></font></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="pds" method="post" action="/Pds/pds_list?page=${page}">
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:pds_search()"><img src="/Images/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
			<td width="25%" align="right">
			<a href="/Admin/pds_write?page=${page}"><img src="/Images/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
