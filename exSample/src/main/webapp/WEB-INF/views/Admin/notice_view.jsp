...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href="/Admin/Notice/notice_modify?page=${page}&idx=${notice.idx}"><b>[수정]</b></a>&nbsp; <a href="/Admin/Notice/notice_delete?page=${page}&idx=${notice.idx}" onclick="return confirm('삭제하시겠습니까?');"><b>[삭제]</b></a>&nbsp; <a href="/Admin/Notice/notice_list?page=${page}"><b>[목록]</b></a></td>
				</tr>
			</table>
		</td>
	</tr>
